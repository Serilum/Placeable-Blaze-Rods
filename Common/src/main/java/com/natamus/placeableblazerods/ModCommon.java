...
public class ModCommon {
	...
	public static void registerAssets(Object modEventBusObject) {
		Services.REGISTERBLOCK.registerBlockWithoutItem(modEventBusObject, ResourceLocation.fromNamespaceAndPath(Reference.MOD_ID, "blaze_rod"), () -> new BlazeRodBlock(BlockBehaviour.Properties.of().strength(0.0F).lightLevel((blockState) -> { return 14; }).sound(SoundType.WOOD).noOcclusion()), true);
	}
